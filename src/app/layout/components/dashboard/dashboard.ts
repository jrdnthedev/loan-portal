...
@Component({
  ...
  imports: [Card, PendingApplication, LoanOfficer, LoadingStencil],
...
export class Dashboard {
  ...
  readonly isLoadingLoans = this.loanStore.isLoading;
  readonly isLoadingUsers = this.adminStore.isLoading;
  // Get the last 3 pending loans for the pending applications display
  readonly recentLoans = computed(() => {
